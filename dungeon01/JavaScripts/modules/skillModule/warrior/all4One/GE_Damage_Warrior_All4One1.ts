...
@MPlugin()
export class GE_Damage_Warrior_All4One1 extends GE_Damage_Base{
    init(): void {
        super.init();

        let modifier1 = MI_Warrior_All4One1_GameModifiterInfo.New();
...
export class MI_Warrior_All4One1_GameModifiterInfo extends GameModifierInfo{
    
    static New(): MI_Warrior_All4One1_GameModifiterInfo {
        return new MI_Warrior_All4One1_GameModifiterInfo();
    }
    ...
    init(): void {
        this.modifierClass = MI_Player_Damage_ModifierClass.New({id:1013,index:0,skillDamageAdd:this.skillDamageAdd});
    }
