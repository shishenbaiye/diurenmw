...
declare namespace mw {
    ...
    class SystemUtil {
         ...
         * @effect 只在客户端调用生效
         * @precautions 只在233悬浮球退出和PIE关闭窗口时生效。悬浮球退出会计时5s，5s后会强制杀进程.
         * @returns 返回一个事件监听器
         */
         ...
         * @groups 玩法
         * @effect 调用端生效
         * @returns 当前环境,返回值包含(Dev/Test/Meta/Pre/Online/dev-oversea/test-oversea/pre-oversea/online-oversea/tc-sa-saopaulo-playza)
         * @example
...
declare namespace mw {
    ...
    class TimeUtil {
         ...
         * @groups 工具
         * @effect 调用端生效
         * @precautions 在 MetaWorld Editor 中，该数值是从每次开始运行起计算，而非从打开 Editor 场景起计算。
