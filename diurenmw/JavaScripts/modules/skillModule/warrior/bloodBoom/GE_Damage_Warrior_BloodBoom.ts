...
@MPlugin()
export class GE_Damage_Warrior_BloodBoom extends GE_Damage_Base{
    init(): void {
        super.init()
        let modifier1 = MI_Warrior_BloodBoom_GameModifiterInfo.New();
...
export class MI_Warrior_BloodBoom_GameModifiterInfo extends GameModifierInfo{
    
    static New(): MI_Warrior_BloodBoom_GameModifiterInfo {
        return new MI_Warrior_BloodBoom_GameModifiterInfo();
    }
    ...
    init(): void {
        this.modifierClass = MI_Player_Damage_ModifierClass.New({id:1006,index:0});
    }  
}