...
@MPlugin()
export class GE_Damage_Mage_FinalThunder extends GE_Damage_Base {
    init(): void {
        super.init();

        let modifier1 = MI_Mage_FinalThunder_GameModifiterInfo.New();
...
export class MI_Mage_FinalThunder_GameModifiterInfo extends GameModifierInfo {

    static New(): MI_Mage_FinalThunder_GameModifiterInfo {
        return new MI_Mage_FinalThunder_GameModifiterInfo();
    }
    ...
    init(): void {
        this.modifierClass = MI_Player_Damage_ModifierClass.New({ id: 2099, index: 0 ,skillDamageAdd:1 , type:2});
    }
}