...
@MPlugin()
export class GE_Damage_Mage_ArcticFeast1 extends GE_Damage_Base {
    init(): void {
        super.init();

        let modifier1 = MI_Mage_ArcticFeast1_GameModifiterInfo.New();
...
export class MI_Mage_ArcticFeast1_GameModifiterInfo extends GameModifierInfo {

    static New(): MI_Mage_ArcticFeast1_GameModifiterInfo {
        return new MI_Mage_ArcticFeast1_GameModifiterInfo();
    }
    ...
    init(): void {
        this.modifierClass = MI_Player_Damage_ModifierClass.New({ id: 2007, index: 0 ,skillDamageAdd:1 , type:2});
    }
}